...
namespace AdminShellNS
{
    ...
    public class AdminShellPackageEnv : IDisposable
    {
        ...
        /// 서버에서 로드한 패키지인지 구분
        /// </summary>
        public bool IsLoadFromServer { get; set; }
        public AdminShellPackageEnv()
        {
        }

        public AdminShellPackageEnv(string aasIdShort, string xmlContent)
        {
            fn = aasIdShort;
            LoadXml(xmlContent);
        }
        ...
        public AdminShellPackageEnv(string fn, bool indirectLoadSave)
        {
            Load(fn, indirectLoadSave);
        }

        public AdminShellPackageEnv(string jsonString)
        {
        ...
        public void SetAasEnv(AdminShell.AdministrationShellEnv env, AdminShell.AdministrationShell administrationShell)
        {
            this.aasenv = env;
            this.aasenv.AdministrationShells.Add(administrationShell);

            //this.aasenv.Assets.Add(administrationShell.assetRef)
        }
        ...
        public bool LoadFromJson(string jsonString)
        {
            ...
            try
            {
                this.aasenv = JsonConvert.DeserializeObject<AdminShell.AdministrationShellEnv>(jsonString);
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex);
            ...
            //var result = (AdminShell.AdministrationShellEnv)serializer.Deserialize(
